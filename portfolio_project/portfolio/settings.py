...
SECRET_KEY = 'y^6gm_x*wdqy-e8bz8+qu7xt88hh=#nwm09(1n0lz&@px^fs+r'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'portfolio_db', # This is the name of the database we created
        'USER': 'postgres',
        'PASSWORD': 'password',
        'HOST': 'localhost',
        'PORT': 5432
...
STATIC_ROOT = os.path.join(BASE_DIR, 'static')  # This is where static files are saved
STATIC_URL = '/static/'
